...
export const userData = {
    ...
    descriptionText: "Étudiant en Master 2 Algorithme et Système Intelligent, orienté Sciences de Données à l'Université de Caen Normandie. Je recherche un stage de fin d'études de 4 à 6 mois à partir de mars 2025. Passionné par l'analyse de données et l'IA, je souhaite contribuer à des projets innovants en data science. Mes compétences incluent la gestion et la transformation des données massive (Pandas, Numpy, SQL), la modélisation prédictive, et le développement de modèles de machine learning (TensorFlow, Keras, PyTorch). J'ai acquis des compétences en visualisation de données (Tableau, Seaborn) et en vision par ordinateur au cours de ma formation. Motivé et curieux, je suis prêt à apporter une valeur ajoutée grâce à mon esprit d'initiative." ,
