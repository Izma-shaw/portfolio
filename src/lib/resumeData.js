...
export const projectsData = [
    ...
    {
        title: "Segmentation d'images et détection de formes",
    ...
    {
        title: "Mini Site de Galerie d'Images en Ligne",
        technologies: "PHP, MVC, MySQL, HTML, CSS, JavaScript",
        desciption: "Développement d'un mini-site de galerie d'images en ligne permettant aux utilisateurs de publier, commenter, et gérer des images. Le projet inclut la gestion des utilisateurs, la publication de posts, et des fonctionnalités d'administration.",
        url: "https://github.com/Izma-shaw/mini-site-galerie-images"
    },
    {
